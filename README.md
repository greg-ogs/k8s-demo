...
http://trouble-1.k8slab.net/lime - should show “lime” page

http://trouble-1.k8slab.net/purple - should show “purple” page
...
http://trouble-2.k8slab.net/teal - should show “teal” page

http://trouble-2.k8slab.net/navy - should show “navy” page
...
Type: ClusterIP
Port: 80
Configure ingress-nginx-controller to use our custom error backend( --default-backend-service )
